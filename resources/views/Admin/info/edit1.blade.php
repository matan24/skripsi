...
@section('title', 'Edit Home | Sistem Informasi')
      ...
      <div id="introCarousel" class="carousel  slide carousel-fade" data-ride="carousel">
       ...
       <section id="contact" class="section-bg">
        <div class="container" data-aos="fade-up">
          ...
          <div class="container">
            <a href="{{ route('Admin.info.showinfo') }}" class="btn btn-info">Kembali</a>
            ...
            <form method="post" action="{{ route('Admin.info.edit1.update', $info->id) }}">
                @method('patch')
                @csrf

            <div class="mb-3">
              <label for="judul" class="form-label">Judul Berita</label>
              <input type="text" class="form-control" name="judul" id="judul" value="{{ $info->judul }}">
            </div>
          
            <div class="mb-3">
              <label for="isi" class="form-label">Isi Berita</label>
              <input type="text" class="form-control" name="isi" id="isi" value="{{ $info->isi }}">
            </div>

            <div class="mb-3">
              <label for="waktu" class="form-label">Waktu</label>
              <input type="text" class="form-control" name="waktu" id="waktu" value="{{ $info->waktu }}">
            </div>
