...
@section('title', 'Data Saran Masyarakat| Sistem Informasi')
      ...
      <section id="contact" class="section-bg">
        <div class="container" data-aos="fade-up">
          ...
          <div class="section-header">
            <h3>Data Saran Masyarakat Kel. Perhentian Marpoyan</h3>
            <p>
            </p>
          </div>
          ...
          <table class="table table-striped table-success">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                      <form action="#" method="#">
                        <button type="submit" class="btn btn-dark"><i class="bi bi-check-square-fill"></i></button><br><br> 
                      </form>
                    </td>
                  </tr>                   
                @endforeach
