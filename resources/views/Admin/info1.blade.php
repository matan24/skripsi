    ...
    <div class="intro-container">
      <div id="introCarousel" class="carousel  slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active" style="background-image: url({{ asset('wow/assets/img/intro-carousel/rr.jpg') }})">
      ...
      <section id="contact" class="section-bg">
        <div class="container" data-aos="fade-up">
          ...
          <div class="section-header">
            <h3>informasi Halaman Home</h3>
            <p>
            </p>
          </div>
          {{-- tambahkan enctype="multipart/form-data" untuk uploud file --}}
          <a href="{{ route('Admin.info.showinfo') }}" class="btn btn-info">Detail data</a><br><br>
          ...
          <form method="post" action="{{ route('Admin.info1.store') }}">
            @csrf
            <div class="form-group">
              <label for="judul">Judul Informasi</label>
              <input class="form-control" name="judul" id="judul"></input>
            </div>
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="waktu" id="waktu"></input>
            </div>
