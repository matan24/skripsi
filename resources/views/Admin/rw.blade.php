...
@section('title', 'Input Data RT/RW | Sistem Informasi')
      ...
      <div id="introCarousel" class="carousel  slide carousel-fade" data-ride="carousel">
       ...
       <section id="contact" class="section-bg">
        <div class="container" data-aos="fade-up">
          ...
          <div class="container">
            <a href="{{ route('Admin.show') }}" class="btn btn-info">Detail data</a>
            ...
            <div class="form-group"><br>
              ...
              <select id="rw" name="rw" class="form-control custom-select">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" name="rw1" id="rw1">
            </div>
          
            <div class="mb-3">
              <label for="rt1" class="form-label">Ketua RT 1</label>
              <input type="text" class="form-control" name="rt1" id="rt1">
            </div>

            <div class="mb-3">
              <label for="rt2" class="form-label">Ketua RT 2</label>
              <input type="text" class="form-control" name="rt2" id="rt2">
            </div>

            <div class="mb-3">
              <label for="rt3" class="form-label">Ketua RT 3</label>
              <input type="text" class="form-control" name="rt3" id="rt3">
            </div>

            <div class="mb-">
              <label for="rt4" class="form-label">Ketua RT 4</label>
              <input type="text" class="form-control" name="rt4" id="rt4">
            </div>

            <div class="mb-3">
              <label for="rt5" class="form-label">Ketua RT 5</label>
              <input type="text" class="form-control" name="rt5" id="rt5">
            </div>

            <div class="mb-3">
              <label for="rt6" class="form-label">Ketua RT 6</label>
              <input type="text" class="form-control" name="rt6" id="rt6">
            </div>

            <div class="mb-3">
              <label for="rt7" class="form-label">Ketua RT 7</label>
              <input type="text" class="form-control" name="rt7" id="rt7">
            </div>

            <div class="mb-3">
              <label for="rt8" class="form-label">Ketua RT 8</label>
              <input type="text" class="form-control" name="rt8" id="rt8">
            </div>

            <div class="mb-3">
              <label for="rt9" class="form-label">Ketua RT 9</label>
              <input type="text" class="form-control" name="rt9" id="rt9">
            </div>
            
            <div class="mb-3">
              <label for="jlhrw" class="form-label">Jumlah RW</label>
              <input type="text" class="form-control" name="jlhrw" id="jlhrw">
            </div>
            
            <div class="mb-3">
              <label for="jlhrt" class="form-label">Jumlah RT</label>
              <input type="text" class="form-control" name="jlhrt" id="jlhrt">
            </div>
