...
@section('title', 'Detail Data Saran Masyarakat | Sistem Informasi')
       ...
       <section id="contact" class="section-bg">
        <div class="container" data-aos="fade-up">
          ...
          <div class="section-header">
            <h3>Data Seluruh Saran Masyarakat</h3>
          ...
          <table class="table table-striped table-success">
            <a href="{{ route('User.infosaran.create') }}" class="btn btn-secondary btn-lg">Kembali</a><br><br>
            ...
            <tbody>
              <tr>
                ...
                <td class="">
                  <a href="{{ route('User.infosaran.ubah', Crypt::encryptString($item->id)) }}" class="btn btn-warning mr-2"><i class="bi bi-pencil"></i></a>

                  <form action="{{ route('User.infosaran.detail.delete', $item->id) }}" method="post">
                    @method('delete')
                    @csrf 
