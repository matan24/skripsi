...
@section('title', 'Saran Masyarakat | Sistem Informasi')
        ...
        <div class="container" data-aos="fade-up">
          ...
          <div class="section-header">
            ...
            <form method="post" action="{{ route('User.create.store') }}">
              ...
              <a href="{{ route('User.infosaran.detail') }}" class="btn btn-info btn-lg">Lihat Semua Saran</a>
              <br>
              @if (session('status'))
              ...
              <div class="form-group">
                ...
                <div class="text-center"><button type="submit" class="btn btn-info btn-lg">Tambah Saran</button></div>
