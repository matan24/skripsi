...
@section('title', 'Informasi | Sistem Informasi')
      ...
      <section id="portfolio" class="section-bg">
        <div class="container" data-aos="fade-up">
          ...
          <header class="section-header">
            <h3 class="section-title">UPDATE INFORMASI</h3>
          </header>
          ...
          <table class="table table-striped table-success">
            ...
            @foreach ( $info as $item )
              <tr>
                ...
                <td>{{ $item->waktu }}</td>
                <td>
                <button type="submit" class="btn btn-danger"><i class="bi bi-check-square-fill"></i></button>
                </td>
              </tr> 
              @endforeach             
            </tbody>
