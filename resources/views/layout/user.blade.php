        ...
        <div class="col-xl-11 d-flex align-items-center">
          ...
          <nav class="nav-menu d-none d-lg-block">
            <ul>
              ...
              <li><a href="{{ route('User.surat') }}">Persyaratan Surat Menyurat</a></li>
              <li><a href="{{ route('User.info') }}">Informasi</a></li>
              <li><a href="{{ route('User.data') }}">Data RT/RW</a></li>
              <li><a href="{{ route('User.infosaran.create') }}">Saran Masyarakat</a></li>
            </ul>
          </nav><!-- .nav-menu -->
        </div>
      </div>
